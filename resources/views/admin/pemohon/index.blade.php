...
@section('page-description', 'Monitoring data pemohon layanan akta')
...
<div class="filter-container">
    <form method="GET" action="{{ route('admin.pemohon.index') }}" id="filterForm">
        <div class="filter-grid">
            <div class="filter-item search-item">
                <div class="search-wrapper">
                    ...
                    @if(request('search'))
                    <a href="{{ route('admin.pemohon.index') }}" class="search-clear">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('admin.pemohon.index') }}" class="btn-reset">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <tr>
                    <td colspan="8">
                        <div class="empty-state">
                            ...
                            <p>Data pemohon akan muncul setelah ada permohonan yang masuk</p>
                        </div>
                    </td>
                </tr>
                @endforelse
...
{{-- Form untuk PDF --}}
<form id="pdfForm" action="{{ route('admin.pemohon.pdf') }}" method="GET" style="display: none;">
...
function openDetailModal(id) {
    ...
    fetch(`{{ route('admin.pemohon.index') }}/${id}`)
