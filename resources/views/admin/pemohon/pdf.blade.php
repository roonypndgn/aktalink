...
<body>
    ...
    <div class="pdf-stats">
        ...
        <div class="pdf-stat">
            <div class="number">{{ $stats['laki'] }}</div>
        ...
        <div class="pdf-stat">
            <div class="number">{{ $stats['belum_isi'] }}</div>
            <div class="label">Belum Terisi</div>
        </div>
    </div>
    ...
    <table class="pdf-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="badge badge-nik">{{ $pemohon->nik }}</span>
                </td>
                <td>
                    <span class="badge 
                        @if($pemohon->jenis_kelamin == 'L') badge-male
                        @elseif($pemohon->jenis_kelamin == 'P') badge-female
                        @else badge-unknown @endif">
                        {{ $pemohon->jenis_kelamin_label }}
                    </span>
                </td>
                <td>{{ $pemohon->tempat_lahir ?? '-' }}</td>
                <td>{{ $pemohon->tanggal_lahir ? $pemohon->tanggal_lahir->format('d/m/Y') : '-' }}</td>
                <td>{{ $pemohon->nomor_hp ?? '-' }}</td>
                <td>{{ Str::limit($pemohon->alamat ?? '-', 40) }}</td>
            </tr>
            @empty
            <tr>
