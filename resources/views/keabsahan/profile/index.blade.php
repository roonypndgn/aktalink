            ...
            <form id="profileForm" class="profile-form" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="text" class="form-input" value="{{ $user->role_label ?? 'Keabsahan' }}" disabled style="background: #f0f5f2; cursor: not-allowed;">
    ...
    if (photoInput) {
        photoInput.addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                fetch('{{ route('keabsahan.profile.update-photo') }}', {
                    method: 'POST',
                    headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (profileForm) {
        profileForm.addEventListener('submit', function(e) {
            ...
            fetch('{{ route('keabsahan.profile.update') }}', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}',
                    'X-Requested-With': 'XMLHttpRequest',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (passwordForm) {
        passwordForm.addEventListener('submit', function(e) {
            ...
            fetch('{{ route('keabsahan.profile.update-password') }}', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}',
                    'X-Requested-With': 'XMLHttpRequest',
