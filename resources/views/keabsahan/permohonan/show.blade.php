...
@section('page-actions')
    <a href="{{ route('keabsahan.permohonan.index') }}" class="btn-outline">
...
<div class="modal-overlay" id="updateStatusModal" style="display: none;">
    <div class="modal-container">
        <div class="modal-content">
            ...
            <form id="updateStatusForm" method="POST" action="{{ route('keabsahan.permohonan.update-status', $permohonan) }}">
                @csrf
...
<div class="modal-overlay" id="tambahKomentarModal" style="display: none;">
    <div class="modal-container">
        <div class="modal-content">
            ...
            <form id="tambahKomentarForm" method="POST" action="{{ route('keabsahan.permohonan.tambah-komentar', $permohonan) }}">
                @csrf
                <div class="modal-body">
                    <div class="form-group full-width">
...
console.log('✅ Keabsahan - Detail Permohonan loaded successfully');
</script>
@endpush