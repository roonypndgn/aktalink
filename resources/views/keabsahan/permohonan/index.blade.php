...
@section('title', 'Permohonan Keabsahan - AKTALINK')
@section('page-title', 'Permohonan Keabsahan')
@section('page-description', 'Kelola permohonan layanan keabsahan')
...
<div class="tab-navigation">
    <a href="{{ route('keabsahan.permohonan.index') }}" 
       class="tab-link {{ Route::currentRouteName() == 'keabsahan.permohonan.index' ? 'active' : '' }}">
    ...
    <a href="{{ route('keabsahan.permohonan.diproses') }}" 
       class="tab-link {{ Route::currentRouteName() == 'keabsahan.permohonan.diproses' ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route('keabsahan.permohonan.sedang-diproses') }}" 
       class="tab-link {{ Route::currentRouteName() == 'keabsahan.permohonan.sedang-diproses' ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <circle cx="12" cy="12" r="10"/>
            <polyline points="12 6 12 12 16 14"/>
        </svg>
    ...
    <a href="{{ route('keabsahan.permohonan.selesai') }}" 
       class="tab-link {{ Route::currentRouteName() == 'keabsahan.permohonan.selesai' ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div class="filter-container">
    <form method="GET" action="{{ route('keabsahan.permohonan.index') }}" id="filterForm">
        <div class="filter-grid">
            <div class="filter-item search-item">
                <div class="search-wrapper">
                    ...
                    @if(request('search'))
                    <a href="{{ route('keabsahan.permohonan.index') }}" class="search-clear">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('keabsahan.permohonan.index') }}" class="btn-reset">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-group">
                            {{-- Detail --}}
                            <a href="{{ route('keabsahan.permohonan.show', $permohonan) }}" class="action-btn view-btn" title="Detail">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="modal-content">
            ...
            <form id="uploadDokumenForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    {{-- Grid untuk Nama Dokumen dan Jenis Dokumen --}}
...
function openUpdateStatusModal(id) {
    window.location.href = `{{ url('keabsahan/permohonan') }}/${id}#updateStatus`;
}
...
function openTambahKomentarModal(id) {
    window.location.href = `{{ url('keabsahan/permohonan') }}/${id}#tambahKomentar`;
}
...
function openProsesModal(id) {
    window.location.href = `{{ url('keabsahan/permohonan') }}/${id}#prosesModal`;
}
...
function openUploadDokumenModal(id) {
    ...
    if (form) {
        form.reset();
        form.action = `{{ url('keabsahan/permohonan') }}/${id}/upload-dokumen`;
    }
...
console.log('✅ Keabsahan - Permohonan module loaded successfully');
</script>
@endpush