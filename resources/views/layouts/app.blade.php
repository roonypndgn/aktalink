                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.permohonan.index') }}"
                               class="nav-link {{ request()->routeIs('admin.permohonan.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.jenis-layanan.index') }}"
                               class="nav-link {{ request()->routeIs('admin.jenis-layanan.*') ? 'active' : '' }}">
                                <i class="nav-icon" data-lucide="layers"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.pemohon.index') }}"
                               class="nav-link {{ request()->routeIs('admin.pemohon.*') ? 'active' : '' }}">
                        ...
                        <div class="profile-menu" id="profileMenu">
                            ...
                            <div class="profile-menu-header">
                                ...
                                <div class="profile-menu-email">
                                    {{ auth()->user()->email ?? auth()->user()->username ?? 'admin@disdukcapil.go.id' }}
                                </div>
                            </div>
                            ...
                            <ul class="profile-menu-list">
                                ...
                                <li>
                                    <a href="{{ route('admin.profile.index') }}" class="profile-menu-link">
                                ...
                                <li>
                                    <a href="{{ route('admin.settings.index') }}" class="profile-menu-link">
