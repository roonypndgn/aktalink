...
<head>
    ...
    <title>
        @yield('title', 'AKTALINK - Kutipan Kedua')
    </title>
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            ...
                            class="nav-link {{ request()->routeIs('kutipan-kedua.permohonan.index') ? 'active' : '' }}">
                ...
                <div class="user-mini">
                    ...
                    <div class="user-mini-info">
                        ...
                        <div class="user-mini-role">
                            {{ auth()->user()->role_label ?? 'Kutipan Kedua' }}
                        </div>
                    </div>
                        ...
                        <div class="profile-menu" id="profileMenu">
                            ...
                            <div class="profile-menu-header">
                                ...
                                <div class="profile-menu-email">
                                    {{ auth()->user()->username ?? 'kutipan@disdukcapil.go.id' }}
                                </div>
                            </div>
                            ...
                            <ul class="profile-menu-list">
                                ...
                                <li>
                                    <a href="{{ route('kutipan-kedua.profile.index') }}" class="profile-menu-link">
