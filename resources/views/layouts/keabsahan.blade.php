...
<head>
    ...
    <title>
        @yield('title', 'AKTALINK - Keabsahan')
    </title>
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            ...
                            class="nav-link {{ request()->routeIs('keabsahan.permohonan.index') ? 'active' : '' }}">
                ...
                <div class="user-mini">
                    ...
                    <div class="user-mini-info">
                        ...
                        <div class="user-mini-role">
                            {{ auth()->user()->role_label ?? 'Keabsahan' }}
                        </div>
                    </div>
                        ...
                        <div class="profile-menu" id="profileMenu">
                            ...
                            <div class="profile-menu-header">
                                ...
                                <div class="profile-menu-email">
                                    {{ auth()->user()->username ?? 'keabsahan@disdukcapil.go.id' }}
                                </div>
                            </div>
                            ...
                            <ul class="profile-menu-list">
                                ...
                                <li>
                                    <a href="{{ route('keabsahan.profile.index') }}" class="profile-menu-link">
