...
<head>
    ...
    <title>
        @yield('title', 'AKTALINK - Surat Pengantar')
    </title>
    ...
    <style>
        ...
        :root {
            ...
            --shadow-sm: 0 4px 15px rgba(8, 35, 26, 0.05);
            --shadow-md: 0 10px 30px rgba(8, 35, 26, 0.08);
        ...
        * {
        ...
        .sidebar {
            ...
            overflow-x: hidden;
            overflow-y: auto;
            background: radial-gradient(circle at 0% 100%, rgba(18, 115, 75, 0.5), transparent 30%),
        ...
        .sidebar-decoration.bottom {
            ...
            right: -150px;
            border-radius: 50%;
            border: 1px solid rgba(244, 179, 42, 0.12);
        }
        ...
        .user-avatar-sidebar {
            ...
            border-radius: 50%;
            color: var(--primary-dark);
            background: linear-gradient(135deg, #ffffff, #dfe9e4);
            font-size: 14px;
            font-weight: 700;
            overflow: hidden;
        }
        ...
        .topbar {
            ...
            border-bottom: 1px solid rgba(220, 228, 224, 0.85);
        ...
        .profile-avatar {
            ...
            border-radius: 50%;
            color: var(--primary-dark);
            background: linear-gradient(135deg, #e6f1eb, #c7ddcf);
            font-size: 12px;
            font-weight: 700;
            overflow: hidden;
        }
        ...
        @media (max-width: 820px) {
            ...
            .sidebar {
                ...
                box-shadow: 15px 0 40px rgba(0, 0, 0, 0.20);
            }
        ...
        a:focus-visible {
            outline: 3px solid rgba(244, 179, 42, 0.65);
            outline-offset: 3px;
        }
...
<body>
    ...
    <div class="app">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-content">
                ...
                {{-- PERMOHONAN --}}
                <div class="nav-section">
                    <span class="nav-section-title">Permohonan</span>
                    <ul class="nav-list">

                        {{-- PERLU DIPROSES --}}
                        <li class="nav-item">
                            <a href="{{ route('surat-pengantar.permohonan.index') }}"
                            class="nav-link {{ request()->routeIs('surat-pengantar.permohonan.index') ? 'active' : '' }}">
                                <i class="nav-icon" data-lucide="clipboard-list"></i>
                                <span class="nav-text">Perlu Diproses</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="sidebar-footer">
                <div class="user-mini">
                    <div class="user-avatar-sidebar">
                        @php
                            $user = auth()->user();
                            $avatarText = $user ? strtoupper(substr($user->name, 0, 2)) : 'AK';
                            $photoPath = $user && $user->photo ? public_path('storage/photos/' . $user->photo) : null;
                    ...
                    <div class="user-mini-info">
                        ...
                        <div class="user-mini-role">
                            {{ auth()->user()->role_label ?? 'Surat Pengantar' }}
                        </div>
                    </div>
                ...
                <div class="topbar-left">
                    ...
                    <div class="breadcrumb">
                        ...
                        <div class="breadcrumb-text">
                            AKTALINK / @yield('page-title', 'Dashboard')
                        </div>
                    </div>
                </div>
                        ...
                        <div class="profile-menu" id="profileMenu">
                            ...
                            <div class="profile-menu-header">
                                ...
                                <div class="profile-menu-email">
                                    {{ auth()->user()->username ?? 'surat@disdukcapil.go.id' }}
                                </div>
                            </div>
                            ...
                            <ul class="profile-menu-list">
                                ...
                                <li>
                                    <a href="{{ route('surat-pengantar.profile.index') }}" class="profile-menu-link">
                                ...
                                <li>
                                    <form action="{{ route('logout') }}" method="POST" id="logout-form">
                                        @csrf
                                        <button type="submit" class="profile-menu-link logout">
    ...
    <script>
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        if (profileButton && profileMenu && profileWrapper) {
