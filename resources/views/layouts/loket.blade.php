            ...
            <div class="sidebar-content">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        ...
                        {{-- DASHBOARD --}}
                        <li class="nav-item">
                            <a href="#" class="nav-link {{ request()->routeIs('loket.dashboard') ? 'active' : '' }}">
                        ...
                        {{-- PEMOHON --}}
                        <li class="nav-item">
                            <a href="{{ route('loket.pemohon.index') }}"
                               class="nav-link {{ request()->routeIs('loket.pemohon.*') ? 'active' : '' }}">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            ...
                            class="nav-link {{ request()->routeIs('loket.permohonan.index') ? 'active' : '' }}">
                ...
                <div class="user-mini">
                    ...
                    <div class="user-mini-info">
                        ...
                        <div class="user-mini-role">
                            {{ auth()->user()->role_label ?? 'Petugas Loket' }}
                        </div>
                    </div>
                        ...
                        <div class="profile-menu" id="profileMenu">
                            ...
                            <div class="profile-menu-header">
                                ...
                                <div class="profile-menu-email">
                                    {{ auth()->user()->username ?? 'petugas@disdukcapil.go.id' }}
                                </div>
                            </div>
