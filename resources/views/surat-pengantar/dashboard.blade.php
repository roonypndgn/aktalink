...
@section('page-description', 'Ringkasan permohonan layanan surat pengantar')
    ...
    <div class="dashboard-left">
        ...
        <div class="dashboard-card">
            <div class="dashboard-card-header">
                ...
                <a href="{{ route('surat-pengantar.permohonan.index') }}" class="card-link">
                    Lihat Semua →
                </a>
            </div>
        ...
        <div class="dashboard-card">
            ...
            <div class="dashboard-card-body">
                <div class="quick-actions">
                    <a href="{{ route('surat-pengantar.permohonan.index') }}" class="quick-action-item" style="background: linear-gradient(135deg, #d1fae5, #a7f3d0);">
                        
                        <span class="quick-label">Semua Permohonan</span>
                    </a>
                    <a href="{{ route('surat-pengantar.permohonan.diproses') }}" class="quick-action-item" style="background: linear-gradient(135deg, #fef3c7, #fde68a);">
                    ...
                    <a href="{{ route('surat-pengantar.permohonan.sedang-diproses') }}" class="quick-action-item" style="background: linear-gradient(135deg, #dbeafe, #93c5fd);">
                    ...
                    <a href="{{ route('surat-pengantar.permohonan.selesai') }}" class="quick-action-item" style="background: linear-gradient(135deg, #d1fae5, #6ee7b7);">
...
console.log('✅ Surat Pengantar Dashboard loaded successfully');
</script>
@endpush