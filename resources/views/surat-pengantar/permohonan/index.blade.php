{{-- resources/views/surat-pengantar/permohonan/index.blade.php --}}

@extends('layouts.surat-pengantar')

@section('title', 'Permohonan Surat Pengantar - AKTALINK')
@section('page-title', 'Permohonan Surat Pengantar')
@section('page-description', 'Kelola permohonan layanan surat pengantar')
...
<div class="tab-navigation">
    <a href="{{ route('surat-pengantar.permohonan.index') }}" 
       class="tab-link {{ Route::currentRouteName() == 'surat-pengantar.permohonan.index' ? 'active' : '' }}">
    ...
    <a href="{{ route('surat-pengantar.permohonan.diproses') }}" 
       class="tab-link {{ Route::currentRouteName() == 'surat-pengantar.permohonan.diproses' ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route('surat-pengantar.permohonan.sedang-diproses') }}" 
       class="tab-link {{ Route::currentRouteName() == 'surat-pengantar.permohonan.sedang-diproses' ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <circle cx="12" cy="12" r="10"/>
            <polyline points="12 6 12 12 16 14"/>
        </svg>
    ...
    <a href="{{ route('surat-pengantar.permohonan.selesai') }}" 
       class="tab-link {{ Route::currentRouteName() == 'surat-pengantar.permohonan.selesai' ? 'active' : '' }}">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div class="filter-container">
    <form method="GET" action="{{ route('surat-pengantar.permohonan.index') }}" id="filterForm">
        <div class="filter-grid">
            <div class="filter-item search-item">
                <div class="search-wrapper">
                    ...
                    @if(request('search'))
                    <a href="{{ route('surat-pengantar.permohonan.index') }}" class="search-clear">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('surat-pengantar.permohonan.index') }}" class="btn-reset">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="tanggal-date">{{ $permohonan->tanggal_permohonan->setTimezone('Asia/Jakarta')->format('d M Y') }}</div>
                        <div class="tanggal-time">{{ $permohonan->tanggal_permohonan->setTimezone('Asia/Jakarta')->format('H:i') }}</div>
                    </td>
                    <td>
    <div class="action-group">
        {{-- Detail --}}
        <a href="{{ route('surat-pengantar.permohonan.show', $permohonan) }}" class="action-btn view-btn" title="Detail">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
.status-btn:hover { background: #fef3c7; color: #92400e; }
.comment-btn:hover { background: #dbeafe; color: #2563eb; }
.proses-btn:hover { background: #d1fae5; color: #065f46; }
...
function openUpdateStatusModal(id) {
    window.location.href = `{{ url('surat-pengantar/permohonan') }}/${id}#updateStatus`;
}
...
function openTambahKomentarModal(id) {
    window.location.href = `{{ url('surat-pengantar/permohonan') }}/${id}#tambahKomentar`;
}
...
function openProsesModal(id) {
    window.location.href = `{{ url('surat-pengantar/permohonan') }}/${id}#prosesModal`;
}
...
function openUploadDokumenModal(id) {
    ...
    if (form) {
        form.reset();
        form.action = `{{ url('surat-pengantar/permohonan') }}/${id}/upload-dokumen`;
    }
...
console.log('✅ Surat Pengantar - Permohonan module loaded successfully');
</script>
@endpush