...
@section('page-description', 'Ringkasan permohonan layanan kutipan kedua')
    ...
    <div class="dashboard-left">
        ...
        <div class="dashboard-card">
            <div class="dashboard-card-header">
                ...
                <a href="{{ route('kutipan-kedua.permohonan.index') }}" class="card-link">
                    Lihat Semua →
                </a>
            </div>
        ...
        <div class="dashboard-card">
            ...
            <div class="dashboard-card-body">
                <div class="quick-actions">
                    <a href="{{ route('kutipan-kedua.permohonan.index') }}" class="quick-action-item" style="background: linear-gradient(135deg, #d1fae5, #a7f3d0);">
                        <span class="quick-icon">📋</span>
                        <span class="quick-label">Semua Permohonan</span>
                    </a>
                    <a href="{{ route('kutipan-kedua.permohonan.diproses') }}" class="quick-action-item" style="background: linear-gradient(135deg, #fef3c7, #fde68a);">
                        <span class="quick-icon">📥</span>
                    ...
                    <a href="{{ route('kutipan-kedua.permohonan.sedang-diproses') }}" class="quick-action-item" style="background: linear-gradient(135deg, #dbeafe, #93c5fd);">
                        <span class="quick-icon">⏳</span>
                    ...
                    <a href="{{ route('kutipan-kedua.permohonan.selesai') }}" class="quick-action-item" style="background: linear-gradient(135deg, #d1fae5, #6ee7b7);">
                        <span class="quick-icon">✅</span>
...
console.log('✅ Kutipan Kedua Dashboard loaded successfully');
</script>
@endpush