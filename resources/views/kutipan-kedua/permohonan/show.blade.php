{{-- resources/views/kutipan-kedua/permohonan/show.blade.php --}}
...
@section('page-actions')
    <a href="{{ route('kutipan-kedua.permohonan.index') }}" class="btn-outline">
                    ...
                    <div class="komentar-item {{ $komentar->is_internal ? 'internal' : 'eksternal' }}">
                        <div class="komentar-header">
                            ...
                            <div class="komentar-meta">
                                ...
                                @endif
                                <span class="komentar-waktu">{{ $komentar->created_at->format('d M Y H:i') }}</span>
                            </div>
                        </div>
...
<div class="modal-overlay" id="updateStatusModal" style="display: none;">
    <div class="modal-container">
        <div class="modal-content">
            ...
            <form id="updateStatusForm" method="POST" action="{{ route('kutipan-kedua.permohonan.update-status', $permohonan) }}">
                @csrf
...
<div class="modal-overlay" id="tambahKomentarModal" style="display: none;">
    <div class="modal-container">
        <div class="modal-content">
            ...
            <form id="tambahKomentarForm" method="POST" action="{{ route('kutipan-kedua.permohonan.tambah-komentar', $permohonan) }}">
                @csrf
                <div class="modal-body">
                    <div class="form-group full-width">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.location.hash) {
        ...
        // Jika hash adalah #updateStatus, buka modal update status
        ...
        // Jika hash adalah #tambahKomentar, buka modal tambah komentar
        if (hash === '#tambahKomentar') {
            setTimeout(function() {
                openTambahKomentarModal();
            }, 800);
        }

        // Jika hash adalah #prosesModal, buka modal proses
        if (hash === '#prosesModal') {
            setTimeout(function() {
                openProsesModal({{ $permohonan->id }});
            }, 800);
        }
    }
});
...
console.log('✅ Kutipan Kedua - Detail Permohonan loaded successfully');
</script>
@endpush