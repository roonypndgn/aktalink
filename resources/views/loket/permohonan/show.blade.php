...
{{-- HAPUS ATAU KOMENTARI TAB NAVIGASI --}}
{{-- 
        ...
        <div class="detail-card">
            ...
            <div class="detail-card-body">
                <div class="info-grid">
                    <div class="info-item full-width">
                        <label>Hasil</label>
                        <p class="info-value">{{ $permohonan->hasilPemeriksaan->hasil ?? '-' }}</p>
                    </div>
                    <div class="info-item">
                        <label>Status</label>
                        <p class="info-value">{{ $permohonan->hasilPemeriksaan->status ?? '-' }}</p>
                    </div>
                    <div class="info-item">
                        <label>Diperiksa Oleh</label>
                        <p class="info-value">{{ $permohonan->hasilPemeriksaan->pemeriksa->name ?? '-' }}</p>
                    </div>
                </div>
            </div>
        </div>
