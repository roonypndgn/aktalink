...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('permohonans', function (Blueprint $table) {
            ...
            $table->foreignId('jenis_layanan_id')->constrained('jenis_layanans')->restrictOnDelete();
            $table->foreignId('status_permohonan_id')->constrained('status_permohonans')->restrictOnDelete();
            $table->foreignId('petugas_loket_id')->constrained('users')->restrictOnDelete();
