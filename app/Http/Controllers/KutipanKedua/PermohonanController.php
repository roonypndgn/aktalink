...
class PermohonanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->whereHas('jenisLayanan', function($query) {
            $query->where('role_tujuan', 'kutipan_kedua');
        })
        ->filter($request->all())
    ...
    private function getStats()
    {
        return [
            'total' => Permohonan::whereHas('jenisLayanan', function($q) {
                $q->where('role_tujuan', 'kutipan_kedua');
            })->count(),
    ...
    public function show(Permohonan $permohonan)
    {
        ...
        return view('kutipan-kedua.permohonan.show', compact('permohonan', 'statuses', 'jenisDokumens'));
    }
    ...
    public function updateStatus(Request $request, Permohonan $permohonan)
    {
        try {
            ...
            RiwayatStatus::create([
                ...
                'changed_by' => auth()->id(),
                'keterangan' => $request->keterangan ?? 'Status diperbarui oleh petugas kutipan kedua',
                'changed_at' => now(),
            ]);
    ...
    public function proses(Request $request, Permohonan $permohonan)
    {
        try {
            ...
            RiwayatStatus::create([
                ...
                'changed_by' => auth()->id(),
                'keterangan' => $request->keterangan ?? 'Permohonan diproses oleh petugas kutipan kedua',
                'changed_at' => now(),
            ]);
